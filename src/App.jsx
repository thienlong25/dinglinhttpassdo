    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .payment-warning { margin:14px 0 0; padding:13px 14px; border:2px solid #ef4444; border-radius:14px; background:#fff1f2; color:#dc2626; font-size:15px; font-weight:950; line-height:1.45; text-align:center; text-transform:uppercase; box-shadow:0 8px 20px rgba(220,38,38,.12); }
